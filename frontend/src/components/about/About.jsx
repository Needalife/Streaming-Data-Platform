...
const About = () => {
  ...
  const teamData = {
    ...
    frontend: {
      ...
      description: "Sean is our brilliant frontend magician who transforms mundane interfaces into dazzling, interactive works of art. Rumor has it that one of his buttons was so mesmerizing it sparked an accidental office disco, complete with spontaneous dance-offs and confetti. Armed with a mastery of React and Tailwind CSS—and a quirky obsession with pixel-perfect puns—Sean work is as clean and captivating as a freshly buffed superhero costume. His creative process often involves debating whether semicolons should have secret powers, all while his code practically sings, ensuring every user’s experience is both beautiful and amusing.",
